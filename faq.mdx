...
description: "Common questions about ContentStats.io. Learn about pricing, supported platforms, API usage, and more."
---
...
<AccordionGroup>
  <Accordion title="What is ContentStats.io?">
    ContentStats.io is a social media analytics API that tracks video performance across TikTok, YouTube, Instagram, and Twitter. We provide hourly snapshots and historical data through a simple REST API.
