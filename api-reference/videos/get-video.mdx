...
description: "Get detailed video data including all snapshots and bot analysis."
---
...
Retrieve complete data for a tracked video, including all hourly snapshots and detailed bot analysis.
...
<ResponseField name="bot_confidence" type="number">
  Overall bot detection score (0.0 - 1.0)
</ResponseField>
...
<ResponseField name="bot_analysis" type="object">
  Detailed bot detection analysis
  
  <Expandable title="Bot Analysis">
    <ResponseField name="overall_confidence" type="number">
      Overall bot score (0.0 - 1.0)
    </ResponseField>
    
    <ResponseField name="engagement_velocity_score" type="number">
      Engagement speed analysis
    </ResponseField>
    
    <ResponseField name="comment_quality_score" type="number">
      Comment authenticity score
    </ResponseField>
    
    <ResponseField name="timing_pattern_score" type="number">
      Timing pattern analysis
    </ResponseField>
    
    <ResponseField name="ratio_analysis_score" type="number">
      Metric ratio analysis
    </ResponseField>
    
    <ResponseField name="channel_context_score" type="number">
      Account context analysis
    </ResponseField>
    
    <ResponseField name="patterns" type="object">
      Detected patterns
    </ResponseField>
...
console.log('Bot score:', video.bot_confidence);
...
echo "Bot confidence: " . $video['bot_confidence'] . "\n";
?>
```
</CodeGroup>
...
```json
{
  ...
  "bot_analysis": {
    ...
    "channel_context_score": 0.16,
    "patterns": {
      "unusual_engagement_spike": false,
      "coordinated_commenting": false,
      "suspicious_timing": false
    },
    "flags": [
      {
        "type": "minor_velocity_spike",
        "severity": "low",
        "description": "Slightly elevated engagement velocity detected",
        "evidence": {
          "spike_time": "2024-01-29T14:00:00.000Z",
          "velocity_increase": "15%"
        },
        "detected_at": "2024-01-29T15:00:00.000Z"
      }
    ]
  },
