...
<AccordionGroup>
  ...
  <Accordion icon="shield-xmark" title="No Bot Detection">
    - YouTube API provides raw numbers
    - No engagement quality analysis
    - Can't detect fake views/likes
    - No comment authenticity scoring
  </Accordion>
</AccordionGroup>
...
<Info>
  We focus on **video performance tracking** and **bot detection**. For content management, use YouTube API.
</Info>
